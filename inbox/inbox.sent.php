...
<tbody>
    ...
    $query = mysqli_query($mysqli,"select * from tabel_pesan where dari='$nm_user' and sent='1' order by waktu");
    ...
    if(isset($_POST['cari'])) {
        ...
        $query = mysqli_query($mysqli,"select * from tabel_pesan where dari='$nm_user' and sent='1' order by waktu desc LIMIT ".(($halaman - 1) * $jml_per_halaman).", $jml_per_halaman");

    } else {
        $query = mysqli_query($mysqli,"select * from tabel_pesan where dari='$nm_user' and sent='1' order by waktu desc LIMIT 0, $jml_per_halaman");
        $halaman = 1; //tambahan
    }
