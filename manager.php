...
<head>
	...
	<meta charset="utf-8" />
	<title>Dashboard - ASKA Manager</title>
...
<li class="purple">
    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
		...
		<span class="badge badge-important">
           ...
           $hasiliapp = mysqli_query($mysqli,"select count(id)as jumcuti from ajuancuti where kd_approve='4' ");
           $dataa = mysqli_fetch_array($hasiliapp);
           $jumlahapp = $dataa['jumcuti'];
           $totalkonfirm=$jumlahct+$jumlahapp;
    ...
    <ul class="dropdown-menu-right dropdown-navbar navbar-pink dropdown-menu dropdown-caret dropdown-close">
        <li class="dropdown-header">
            ...
            echo "$totalkonfirm Pemberitahuan";
            ?>
                    ...
                    if($totalkonfirm==0){
                    	...
                    	if($jumlahapp > 0){
							...
							<span class='pull-right badge badge-success'>" . $jumlahapp . "</span>
							      </div>
							</a>
							</li>";
