...
<tbody>
        ...
        $jml_data = mysqli_num_rows(mysqli_query($mysqli,"SELECT * FROM tbl_absen order by id_abs desc"));
        ...
        // query jika nomor halaman sudah ditentukan
            ...
            $query = mysqli_query($mysqli,"SELECT * FROM tbl_absen order by id_abs desc LIMIT ".(($halaman - 1) * $jml_per_halaman).", $jml_per_halaman");
        // query ketika tidak ada parameter halaman maupun pencarian
        } else {
            $query = mysqli_query($mysqli,"SELECT * FROM tbl_absen order by id_abs desc  LIMIT 0, $jml_per_halaman");
            $halaman = 1; //tambahan
        }
