...
<h3 class="header smaller lighter blue">Referensi Jabatan</h3>
			...
			<thead>
			<a  href="#dialog-jab" id="0" class="tambah btn btn-app btn-purple btn-xs" data-toggle="modal" >
			<i class="ace-icon fa fa-pencil-square-o bigger-160"></i>
			Tambah
			<span class="badge badge-warning badge-right"></span>
			</a>

			<a href="cetak/lap_cetakjur.php" class="btn btn-app btn-light btn-xs">
...
<div id="dialog-jab" class="modal fade" tabindex="-1" aria-hidden="true">
