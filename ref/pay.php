...
<html>
<body>
<h3 class="header smaller lighter blue">Referensi Payroll</h3>
			...
			<thead>
			<a  href="#dialog-pay" id="0" class="tambah btn btn-app btn-purple btn-xs" data-toggle="modal" >
			...
			<a href="?id=payroll" class="btn btn-app btn-success btn-xs">
...
<div id="dialog-pay" class="modal fade" tabindex="-1">
...
<div class="modal-content">
	...
	<div class="modal-footer">
		...
		<button id="simpan-pay" class="btn btn-success" data-dismiss="collapse" aria-hidden="true" >Simpan</button>
	</div>
</div>
</div>
</div>
