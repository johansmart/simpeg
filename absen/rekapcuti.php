    ...
    <div class="widget-box widget-color-blue">
        <div class="widget-header widget-header-small">
            <h6 class="widget-title">
                ...
                Rekapitulasi Berdasarkan Tanggal Pengajuan Cuti
            </h6>
        ...
        <form action="cetak/lap_cutiharian.php" target="_blank" class="form-horizontal" method="POST" > 
			<div class="widget-main">
				<ul class="list-unstyled spaced2">
					...
					<div class="form-group">
                        ...
                        <div class="col-sm-5">
							...
							<input type="submit" name="hari" class="btn btn-warning" value="Cetak" />
                        </div>
                    </div>
...
<div class="col-xs-12 col-sm-6 widget-container-col">
    <div class="widget-box widget-color-blue">
        <div class="widget-header widget-header-small">
            <h6 class="widget-title">
                <i class="ace-icon fa fa-sort"></i>
                Rekapitulasi Berdasarkan Bulan Pengajuan Cuti
            </h6>
        ...
        <form action="cetak/lap_cutibulan.php" target="_blank" class="form-horizontal" method="POST" > 
			<div class="widget-main">
				<ul class="list-unstyled spaced2">
					<div class="form-group">
