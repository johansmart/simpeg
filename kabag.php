...
if ($sesi_username != NULL || !empty($sesi_username) ||$_SESSION['leveluser']=='6'  )
{
if (!login_check()) {
    echo "
...
<head>
	...
	<meta charset="utf-8" />
	<title>Dashboard - ASKA Kabag</title>
...
<li class="purple">
    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
		...
		<span class="badge badge-important">
           ...
           $hasiliap = mysqli_query($mysqli,"select count(id)as jumcuti from ajuancuti where kd_approve='3' and kdnotif='0' and jab_atasan='$sesi_id_jab'");
           $dataiap = mysqli_fetch_array($hasiliap);
           $jumlahap = $dataiap['jumcuti'];

          

           $totaljt=$jumlahct+$jumlahap ;
           echo "$totaljt";
        ...
        <li class="dropdown-header">
            ...
            ?>
                    ...
                    if($totaljt==0){
						...
						<span class='pull-right badge badge-success'>" . $jumlahct . "</span>
						      </div>
						</a>
						</li>";
                    	...
                    	if($jumlahap > 0){
							...
							<span class='pull-right badge badge-success'>" . $jumlahap . "</span>
							      </div>
							</a>
							</li>";
...
<li class="<?php echo $classmenu2 ?>">
    ...
    <li class="<?php echo $classmenu4 ?>">
        <a href="#" class="dropdown-toggle">
            ...
            <span class="menu-text"> Data Absen & Cuti </span>
